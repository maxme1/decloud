import { c as create_ssr_component, b as compute_rest_props, s as setContext, d as spread, f as escape_object, g as escape_attribute_value, h as getContext, i as add_attribute, e as escape, j as compute_slots, a as subscribe, v as validate_component, k as each } from "../../chunks/ssr.js";
...
const ZoomableImage_svelte_svelte_type_style_lang = "";
const MessageContent_svelte_svelte_type_style_lang = "";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<div class="h-screen"><div class="flex">${validate_component(Sidebar, "Sidebar").$$render($$result, { activeUrl, activeClass, nonActiveClass }, {}, {
    default: () => {
      return `${validate_component(SidebarWrapper, "SidebarWrapper").$$render($$result, {}, {}, {
        default: () => {
          return `${validate_component(SidebarGroup, "SidebarGroup").$$render($$result, {}, {}, {
            default: () => {
              return `${each(chats, (chat) => {
                return `${validate_component(SidebarItem, "SidebarItem").$$render($$result, { label: chat[1] }, {}, {
                  default: () => {
                    return ` `;
                  }
                })}`;
